...
urlpatterns = [
    ...
    path('collection_centre/<int:id>/item_in/', views.CollectionCenterItemInView.as_view(), name='collection_centres_item_in_view'),
    url(r'collection_centre/item_out/(?P<center_id>\w+)/$', views.CollectionCenterItemOutView.as_view(), name='collection_centres_item_out_view'),
